    ...
    return Positioned(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                child:ButtonClass(color: constantColors.yellowColor, icon: EvaIcons.emailOutline,) ,
                onTap: () => emailAuthSheet(context),
              ),

              GestureDetector(
                child: ButtonClass(color: constantColors.redColor, icon: EvaIcons.google,),
                onTap: () =>
              ...
              GestureDetector(child: ButtonClass(color: constantColors.blueColor, icon: EvaIcons.facebook,)),
            ],
          ),
        ),
    );
              ...
              Row(
                ...
                children: [
                  ...
                  color: constantColors.redColor,
                      ...
                      onPressed: (){
                        Provider.of<LandingUtils>(context,listen: false).selectAvatarOperation(context);
                      }
                  ),
